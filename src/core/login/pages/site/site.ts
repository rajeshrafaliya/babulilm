...
export class CoreLoginSitePage {
     ...
     */
    showHelp(): void {
        this.utils.openInApp('https://babulilm.co.uk/contact-us');
// RAJESH        const modal = this.modalCtrl.create('CoreLoginSiteHelpPage', {}, { cssClass: 'core-modal-fullscreen' });
// RAJESH       modal.present();
    }
